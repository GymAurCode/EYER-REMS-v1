-- AlterTable: Add subsidiaryOptionId to Property
DO $$
BEGIN
...
-- CreateIndex: Create index for subsidiaryOptionId
CREATE INDEX IF NOT EXISTS "Property_subsidiaryOptionId_idx" ON "Property"("subsidiaryOptionId");

-- AddForeignKey: Property.subsidiaryOptionId -> SubsidiaryOption.id
